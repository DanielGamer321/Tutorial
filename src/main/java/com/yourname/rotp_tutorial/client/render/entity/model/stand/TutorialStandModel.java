package com.yourname.rotp_tutorial.client.render.entity.model.stand;
...
public class TutorialStandModel extends HumanoidStandModel<TutorialStandEntity> {
	...
	protected void initActionPoses() {
        actionAnim.put(StandPose.RANGED_ATTACK, new PosedActionAnimation.Builder<TutorialStandEntity>()
	...
	@Override
	protected ModelPose<TutorialStandEntity> initIdlePose() {
	...
	@Override
	protected ModelPose<TutorialStandEntity> initIdlePose2Loop() {
		return new ModelPose<>(new RotationAngle[] {
